...
This directory contains the code that was used to produce the results from subsection 7.1 as well as the 2D results from subsection 7.2 of the article mentioned in the `README.md` file outside this folder.
